...
public class CircularDoubleBufferedQueue<E> extends AbstractQueue<E> implements BlockingQueue<E>, java.io.Serializable {
    ...
    /**
     * switch condition: read queue is empty && write queue is not empty Notice:This function can only be invoked after
     * readLock is grabbed, or may cause dead lock
     * 
     * @param timeout
